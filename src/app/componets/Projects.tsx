  ...
  return (
    <section className='container'>
        ...
        <div className="row1">
          ...
          {/* <div className="box_size_one hover-b" style={{ backgroundImage: 'url(/img3.jpg))' }}>
            <div className="re-collect-b"><h6 className="hsix-heading">BUTTERFLY PARK</h6><p className="butterfly para">Butterfly Park in Bengaluru is a joined initiative by the Zoo Authority of Karnataka, Department of Biotechnology with exclusive focus on butterflies. The aim of the project is to build curiosity, impart knowledge alongside conserving local butterfly breeds...<a className="btn-read">Read More</a></p>
              <div>
              </div>
            </div>
          </div> */}
        ...
        <div className="row2">
          <div className="box_size_three hover-c"  style={{ backgroundImage: 'url(/3.jpg))' }}>
            <div className="re-collect-c">
              ...
              <div>
                ...
                <div className="box_size_four hover-d"  style={{ backgroundImage: 'url(/img3.jpg)' }}><div className="re-collect-d"><h6 className="hsix-heading">RAILWAY STATION</h6><p className="railway-station para">Baiyappanahalli in Bengaluru is the first centralized AC Railway Terminal. It’s elegant swooping roof with undulating shape forming a canopy of strong visual identity similar to Bengaluru Airport is built by Tata Structura’s 600 MT superior quality steel...<a className="btn-read">Read More</a></p><div>
                  </div>
                  </div>
                  </div>
                  <div className="box_size_three hover-e"  style={{ backgroundImage: 'url(/img3.jpg)' }}><div className="re-collect-e">
                    ...
                    <div>
                      ...
                      <div className="box_size_three hover-f"  style={{ backgroundImage: 'url(/img3.jpg)' }}>
                        <div className="re-collect-f">
                          ...
                          <div>
                            ...
                            <div className="box_size_three hover-g"  style={{ backgroundImage: 'url(/img3.jpg)' }}>
                            ...
                            <div>
                              ...
                              <div className="box_size_three hover-h"  style={{ backgroundImage: 'url(/img3.jpg)' }}>
                                <div className="re-collect-h">
                                  ...
                                  <div>
                                    ...
                                    <div className="box_size_three hover-i"  style={{ backgroundImage: 'url(/img3.jpg)' }}>
