  ...
  return (
    <div>
      <div className="feature_product">
          ...
          <div className="row">
            <div className="col-sm-12">
              ...
              <div className="multi_size">
                ...
                <div className="row2">
                <div className="box_size_three hover-c" style={{background: url(&quot;./static/media/fp3.4508cbb2aa93a8137874.jpg&quot;);}}><div className="re-collect-c">
        ...
        <div className="box_size_four hover-d" style="background: url(&quot;./static/media/fp4.e72a80903411686a5318.jpg&quot;);">
            <div className="re-collect-d">
            <h6 className="hsix-heading">RAILWAY STATION</h6>
            <p className="railway-station para">Baiyappanahalli in Bengaluru is the first centralized AC Railway Terminal. It’s elegant swooping roof with undulating shape forming a canopy of strong visual identity similar to Bengaluru Airport is built by Tata Structura’s 600 MT superior quality steel...<a className="btn-read">Read More</a></p>
            <div>

        </div>
    </div>
    </div><div className="box_size_three hover-e" style="background: url(&quot;./static/media/fp5.aab1aa22d3dfddf92e98.jpg&quot;);"><div className="re-collect-e"><h6 className="hsix-heading">BISWA BANGLA GATE</h6>
            <p className="biswa-bangala-gate para">Biswa Bangla Gate in Kolkata is a design concept in attempt to pay homage to Rabindranath Tagore and his composition ‘where the mind is without fear’. Stands to portray the image of the metropolis as united in strength, dynamic in progress and liberal in outlook for all streams of creativity...<a className="btn-read">Read More</a>
        </p>
            <div>
        ...
        <div className="box_size_three hover-f" style="background: url(&quot;./static/media/fp6a.c2c3a9b12ee7174d1127.jpg&quot;);">
        ...
        <div className="box_size_three hover-g" style="background: url(&quot;./static/media/fp7.452657101dd75abead67.jpg&quot;);"><div className="re-collect-g">
            <h6 className="hsix-heading">INDIRA GANDHI STADIUM</h6>
            <p className="stadium para">A notable feature of the Indira Gandhi Indoor Stadium Complex in Delhi is the arch of the cycling velodrome. It complies with new benchmarks of track events. It is fully covered and air-conditioned...<a className="btn-read">Read More</a></p><div>

            </div>
        </div>
    </div>
    <div className="box_size_three hover-h" style="background: url(&quot;./static/media/fp8a.208d0b6958c2acb5f68e.jpg&quot;);">
...
<div className="box_size_three hover-i" style="background: url(&quot;./static/media/fp9.4d27e4db1b029ea90542.jpg&quot;);">
    <div className="re-collect-i">
    <h6 className="hsix-heading">RAIPUR AIRPORT</h6>
    <p className="raipur-airport para">Raipur Airport is one of the busiest airport in Chhattisgarh. The apron has 6 parking bays which can accommodate aircraft, helipad...<a className="btn-read">Read More</a></p>
    <div>

    </div>
</div>
</div>
<div className="box_size_three hover-j" style="background: url(&quot;./static/media/fp10.5dfd20a33e4bf449ab61.jpg&quot;);">
        <div className="re-collect-j">
            <h6 className="hsix-heading">MYSORE GLASS HOUSE</h6><p className="mysore-glass-house para">Mysore Glass House located in Kuppana Park; Mysore is a modern ecofriendly building widely known for exclusive flower exhibits during the internationally acclaimed “Mysore Dasara” festival that takes place every year...<a className="btn-read">Read More</a>
            </p>
            <div>
