    ...
    return (
        <>
            <div className="container py-5">
                <h4 className='text-center font-bold'>SHS WEIGHT TABLE</h4>
                <div className='flex justify-between mb-3'>
                <a href="#" className=''><img src="/pdf_icon.png" alt="" /></a>
                <button className="readmoreblue px-3 py-2 m-2 text-xs no-underline  border-blue-500 border text-blue-500"> View </button>
