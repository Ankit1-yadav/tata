...
const page = () => {
  return (
    <div>
    <Hero title="TATA STRUCTURA YST  355" subtitle="Tata Structura YST 355 is a brand of galvanized steel hollow sections from the house of Tata Steel." img="/yst355.jpg" />
 <Abouty/>
    <Benefits/>
    <Slider/>
    <Table/>
